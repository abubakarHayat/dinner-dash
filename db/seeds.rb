...
# items
bir_item = Item.create({ item_title: 'Biryani', item_description: 'Masala rice with meat', item_price: 250,
                         is_sold: true,
...
pul_item = Item.create({ item_title: 'Pulao', item_description: 'Stew rice with meat', item_price: 250, is_sold: true,
                         restaurant_id: desi_rest.id })
qor_item = Item.create({ item_title: 'Qourma', item_description: 'Spicy masala curry meat', item_price: 350,
                         is_sold: true,
                         restaurant_id: desi_rest.id })

spa_item = Item.create({ item_title: 'Spaghetti', item_description: 'Noodles with meat balls', item_price: 300,
                         is_sold: true,
...
pas_item = Item.create({ item_title: 'Pasta', item_description: 'Simple handmade pasta', item_price: 250, is_sold: true,
                         restaurant_id: it_rest.id })
ter_item = Item.create({ item_title: 'Terramizu', item_description: 'Sweet creamy dessert', item_price: 410,
                         is_sold: true,
                         restaurant_id: it_rest.id })

bef_item = Item.create({ item_title: 'Beef Burger', item_description: 'Cheesy burger with beef patty', item_price: 400,
                         is_sold: true,
...
piz_item = Item.create({ item_title: 'Pizza', item_description: 'Chicken fajita pizza', item_price: 720, is_sold: true,
                         restaurant_id: ff_rest.id })
chi_item = Item.create({ item_title: 'Chicken wings', item_description: 'Spicy chicken wings with BBQ sauce',
                         item_price: 550,
                         is_sold: true,
                         restaurant_id: ff_rest.id })
